<!-- Gestión de la autenticación en dos pasos: activar, desactivar y códigos de recuperación. -->
<script lang="ts">
    import { Form } from '@inertiajs/svelte';
    import ShieldCheck from 'lucide-svelte/icons/shield-check';
    import { onDestroy } from 'svelte';
    import Heading from '@/components/common/Heading.svelte';
    import TwoFactorRecoveryCodes from '@/components/settings/TwoFactorRecoveryCodes.svelte';
    import TwoFactorSetupModal from '@/components/settings/TwoFactorSetupModal.svelte';
